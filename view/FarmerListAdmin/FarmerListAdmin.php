                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <button type="button" class="btn btn-warning btn-sm btn_edit tt" data-toggle="tooltip" title="แก้ไขข้อมูล" uid="<?php echo $FARMER[$i]["UFID"]; ?>" titles="<?php echo $FARMER[$i]["Title"]; ?>" formalid="<?php echo $formalid; ?>" fname="<?php echo $FARMER[$i]["FirstName"]; ?>" lname="<?php echo $FARMER[$i]["LastName"]; ?>" mail="<?php echo $FARMER[$i]["EMAIL"]; ?>" type_email="<?php echo $FARMER[$i]["ETID"]; ?>" address="<?php echo $FARMER[$i]["Address"]; ?>" province="<?php echo $FARMER[$i]["AD1ID"]; ?>" distrinct="<?php echo $FARMER[$i]["AD2ID"]; ?>" subdistrinct="<?php echo $FARMER[$i]["AD3ID"]; ?>">
