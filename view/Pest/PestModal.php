    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog">
        <form method="post" id="formEdit" name="formEdit" action="manage.php">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header header-modal" style="background-color: <?= $color ?>;">
                        <h4 class="modal-title">รายละเอียดการตรวจพบศัตรูพืช</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="main-edit">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-xl-8 col-10">
                                    <label for="" id="e_pesttype" name="e_pesttype"></label>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-xl-8 col-10">
                                    <label for="" id="e_pest" name="e_pest"></label>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 " style="text-align: center;">
                                    <div style="text-align: center;">
                                        <img id='data_icon' src='' width="120" height="120" alt="User"
