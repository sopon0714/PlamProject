                       ...
                       <div class="divName">
                           <div class="form-group">
                               <div class="form-inline">
                                   ...
                                   <input id='name' name='name_insert' class='form-control col-8' required="" oninput="setCustomValidity(' ')" placeholder="ใส่ชื่อปุ๋ย">
                               </div>
                           </div>
                           <div class="form-group">
                               <div class="form-inline">
                                   <label for="" class="col-4">ชื่อย่อปุ๋ย <span class="ml-2"> *</span></label>
                                   <input type='text' id='alias' name='alias_insert' class='form-control col-8' required="" oninput="setCustomValidity(' ')" Placeholder="ใส่ชื่อย่อ">
                               </div>
                           </div>
                       </div>
                       <div class="form-group divHolder">
                           <div class="form-inline">
                               <label for="" class="col-4">ไอคอนปุ๋ย</label>
                               <div class="UI">
