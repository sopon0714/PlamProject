...
<?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold" style="color:#006664">รายชื่อวัชพืช</h6>
    ...
    <div class="body">
        <div class="card-body">
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" id="silder">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src=<?php echo  $src = "../../picture/Pest/weed/style/" . $row["PID"] . "/" . $row["Icon"]; ?> style="height:200px;">

                            </div>
                            <?php for ($style_index = 0; $style_index < $row["NumPicChar"] - 1; $style_index++) { ?>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src=<?php echo  $src = "../../picture/Pest/weed/style/" . $row["PID"] . "/" . $style_index . "_" . $row["Icon"]; ?> style="height:200px;">
                                </div>
                            <?php } ?>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <h6 style="color:#006664">อันตรายของวัชพืช</h6>
                    <span class="more">
                        <?php echo $row["Danger"]; ?>
                    </span>
                    <br>
                    ...
                    <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" id="silder">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src=<?php echo  $src = "../../picture/Pest/weed/danger/" . $row["PID"] . "/" . $row["Icon"]; ?> style="height:200px;">

                            </div>
                            <?php for ($danger_index = 0; $danger_index < $row["NumPicDanger"] - 1; $danger_index++) { ?>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src=<?php echo  $src = "../../picture/Pest/weed/danger/" . $row["PID"] . "/" . $danger_index . "_" . $row["Icon"]; ?> style="height:200px;">
                                </div>
                            <?php } ?>
                        </div>
