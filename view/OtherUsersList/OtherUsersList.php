                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <button type="button" class="btn btn-warning btn-sm btn_edit tt" data-toggle="tooltip" title="แก้ไขข้อมูล" uid="<?php echo $USER[$i]["UID"]; ?>" titles="<?php echo $USER[$i]["Title"]; ?>" username="<?php echo $USER[$i]["UserName"]; ?>" fname="<?php echo $USER[$i]["FirstName"]; ?>" lname="<?php echo $USER[$i]["LastName"]; ?>" mail="<?php echo $USER[$i]["EMAIL"]; ?>" type_email="<?php echo $USER[$i]["ETID"]; ?>" department="<?php echo $USER[$i]["DID"]; ?>" admin="<?php echo $USER[$i]["IsAdmin"]; ?>" admin2="<?php echo $USER[$i]["IsAdmin2"]; ?>" research="<?php echo $USER[$i]["IsResearch"]; ?>" operator="<?php echo $USER[$i]["IsOperator"]; ?>" farmer="<?php echo $USER[$i]["IsFarmer"]; ?> ">
