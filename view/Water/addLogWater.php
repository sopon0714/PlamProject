...
$sql_Insert = "INSERT INTO `log-watering`(`ID`, `isDelete`, `Modify`, `LOGloginID`, `DIMdateID`, `StartTime`, `StopTime`, `DIMownerID`, `DIMfarmID`, `DIMsubFID`, `Period`) 
                                    VALUES (NULL,0,$t,-1,$dim_date,$StartTime,$StopTime,$dim_owner,$dim_farm,$dim_subfarm,$peroid)";
addinsertData($sql_Insert);

echo "\n\n" . $dim_date . " " . $dim_farm . " " . $dim_subfarm . " " . $dim_owner . " " . $StartTime . "\n\n";
