...
$sql = "SELECT dt.Date,lw.DIMdateID,S.FID,S.SFID AS 'SFID',S.DSFID,S.UID,S.Name,S.FName,S.SFName AS 'subFName',S.SumArea,S.SumNumTree,S.Latitude,S.Longitude,MIN(lw.StartTime) AS mStime,MAX(lw.StopTime) AS MStime,SUM(lw.Period) AS 'SUMTIME'
